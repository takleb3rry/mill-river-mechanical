...
Workshop starter kit. Brand assets, the demo website, and (coming soon) a setup kit with pre-seeded dummy data and instructions.
Website source. Vercel deploys the `website/` folder on every push to `main`.
Live demo site: URL added after first deploy
Repository layout
```
...
Brand assets: see `brand/README.md`.
Website: see `website/README.md`.
Demo data and setup instructions: see `demo-kit/`.
Notice
